...
class B2DynamicTree
{
	...
	*/
	 ...
	 */
	inline public function createProxy(aabb:B2AABB, userData:Dynamic):B2DynamicTreeNode
	{
	 ...
	 */
	inline public function destroyProxy(proxy:B2DynamicTreeNode):Void
	{
	 ...
	 */
	inline public function moveProxy(proxy:B2DynamicTreeNode, aabb:B2AABB, displacement:B2Vec2):Bool
	{
		B2Settings.b2Assert(proxy.isLeaf());
	...
	inline public function getFatAABB(proxy:B2DynamicTreeNode):B2AABB
	{
		return proxy.aabb;
	}
	 ...
	 */
	inline public function getUserData(proxy:B2DynamicTreeNode):Dynamic
	{
	...
	inline private function allocateNode():B2DynamicTreeNode
	{
	...
	inline private function freeNode(node:B2DynamicTreeNode):Void
	{
		node.parent = m_freeList;
		m_freeList = node;
	}

	inline private function insertLeaf(leaf:B2DynamicTreeNode):Void
	{
		++m_insertionCount;
	...
	inline private function removeLeaf(leaf:B2DynamicTreeNode):Void
	{
		if ( leaf == m_root)
		{
			m_root = null;
