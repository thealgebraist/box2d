...
class B2DynamicTreeBroadPhase implements IBroadPhase
{
	 ...
	 */
	inline public function createProxy(aabb:B2AABB, userData:Dynamic):Dynamic
	{
	 ...
	 */
	inline public function destroyProxy(proxy:Dynamic):Void
	{
		unBufferMove(proxy);
		--m_proxyCount;
	 ...
	 */
	inline public function moveProxy(proxy:Dynamic, aabb:B2AABB, displacement:B2Vec2):Void
	{
	...
	inline public function testOverlap(proxyA:Dynamic, proxyB:Dynamic):Bool
	{
	 ...
	 */
	inline public function getUserData(proxy:Dynamic):Dynamic
	{
	 ...
	 */
	inline public function getFatAABB(proxy:Dynamic):B2AABB
	{
	 ...
	 */
	inline public function getProxyCount():Int
	{
		return m_proxyCount;
	}
	 ...
	 */
	inline public function updatePairs(callbackMethod:Dynamic):Void
	{
		m_pairCount = 0;
	 ...
	 * @inheritDoc
	 */
	inline public function query(callbackMethod:Dynamic -> Bool, aabb:B2AABB):Void
	{
	 ...
	 * @inheritDoc
	 */
	inline public function rayCast(callbackMethod:B2RayCastInput -> Dynamic -> Float, input:B2RayCastInput):Void
	{
	...
	inline public function rebalance(iterations:Int):Void
	{
	...
	inline private function bufferMove(proxy:B2DynamicTreeNode):Void
	{
		m_moveBuffer[m_moveBuffer.length] = proxy;
	}

	inline private function unBufferMove(proxy:B2DynamicTreeNode):Void
	{
		m_moveBuffer.remove (proxy);
	}

	inline private function comparePairs(pair1:B2DynamicTreePair, pair2:B2DynamicTreePair):Int
	{
		//TODO_BORIS:
