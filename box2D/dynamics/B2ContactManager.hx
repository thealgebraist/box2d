...
class B2ContactManager
{
	...
	inline public function addPair(proxyUserDataA:Dynamic, proxyUserDataB:Dynamic):Void {
	...
	inline public function findNewContacts():Void
	{
	...
	// contact list.
	inline public function collide() : Void
	{
